    ...
    await query.edit_message_text(f"**{query.from_user.mention} : مرحباً بك عزيزي **\n\n**انا بوت تشغيل موسيقى صوتية ومرئية .⚡**\n**قم بإضافة البوت إلي مجموعتك او قناتك .⚡**\n**سيتم تفعيل البوت وانضمام المساعد تلقائياً**\n**في حال مواجهت مشاكل انضم هنا **\n**@ **\n**استخدم الازرار لمعرفه اوامر الاستخدام .⚡ **",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("ᏒꪮᎩᥲ️Ꮮ", url=f"https://t.me/Ux_Uv")],
                [
...
Powered By [{OWNER_NAME}]""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("Donate", url=f"https://t.me/Ux_Uv")
                ],
                [
...
💡 **If you have a follow-up questions about this bot, you can tell it on my support chat here: @Ux_UvᏢᏞᥲᎩᎥꪀᎶᏢᏞᥲᎩᎥꪀᎶ**
...
» • قسم الاذاعه • : لعرض قسم التحكم ف الاذاعه والتوجيه
...
💡 **في حال واجهت اي مشكلة اخري يمكنك التواصل مع المطور من هن : {Ꮆ𝘳ꪮ𝚄Ꮲ} **
⚡ __ ᦔꫀ𝚅ꫀᏞꪮᏢꫀr ᏴᎩ [{OWNER_NAME}]""",
        reply_markup=InlineKeyboardMarkup(
...
⚡️ __ ᦔꫀ𝚅ꫀᏞꪮᏢꫀr ᏴᎩ by [{OWNER_NAME}]""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("العودة", callback_data="bcmds")]]
        ),
    )
